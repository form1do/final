...
if (neededNumber > 0) {
System.Console.WriteLine($"Среди {lengthArray} строк, введенных Вами {neededNumber} содержат меньше четырех символов. Вот они:");
PrintArray(arrayForPrint);
}
else 
System.Console.WriteLine ($"Среди {lengthArray} строк, введенных Вами нет подходящих заданным условиям") ;
